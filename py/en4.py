...
# ==============================================================================
# XuePilot OER Spider (V10.0 满天星终极收割版 - 全域英文+数理+百年经典+世界童话)
# 核心使命：无死角遍历纯英文小学(K-6)、北美/英联邦、核心数学、港台语料及世界童话。
...
class XuePilotK12Spider:
    ...
    # ==========================================================================
    # 🎯 集群 1：K-6 纯英文核心数学与科普 (Wikibooks/Wikijunior)
    # ==========================================================================
    def harvest_wiki_math_and_science(self):
        print("\n" + "★"*60)
        print(" 🚀 [集群 1: 核心数理] 启动纯英文数学与科学教科书全量收割...")
        print("★"*60)
        ...
        books = [
            ...
            ("tb_wiki_geometry", "Wikibooks: Geometry (Grade 7-10 Math)", "https://en.wikibooks.org/wiki/Geometry", "📏"),
        ...
        for book_id, title, url, icon in books:
            ...
            try:
                ...
                data = {
                    "code_id": book_id, "title": title, "provider_type": "Primary/Middle Core (K-9)", 
                    "icon": icon, "is_free": True, "source_url": url,
                    "description": "开源纯英文核心教材。涵盖数学基础代数/几何与非虚构类科普。",
    ...
    # ==========================================================================
    # 🎯 战略集群 2：英联邦与北美纯正读物 (新增 Elson Readers)
    # ==========================================================================
        ...
        for book_id, title, url, icon in books:
            ...
            try:
                ...
                data = {
                    ...
                    "icon": icon, "is_free": True, "source_url": url,
                    "description": "横跨美、加、英、澳的国民级经典语文分级教材。提供最纯正的英语思维训练底座。",
    ...
    def harvest_global_fairy_tales(self):
        ...
        for book_id, title, url, icon in books:
            ...
            try:
                ...
                data = {
                    "code_id": book_id, "title": title, "provider_type": "World Literature (K-6)", 
                    "icon": icon, "is_free": True, "source_url": url,
                    "description": "西方小学 Language Arts（语言艺术）必读的世界经典童话与寓言原著，想象力与道德哲理的双重启蒙。",
                    "chapters_json": chapters
                }
                self.push_to_db("edu_textbooks", data)
                time.sleep(2)
    ...
    # ==========================================================================
    # 🎯 战略集群 4：港台地区国文与核心素养 (HK/TW Traditional Chinese)
    # ==========================================================================
    ...
    # ==========================================================================
    # 🎯 战略集群 5：OpenStax Middle School (初中阶预备教材)
    # ==========================================================================
    def harvest_openstax_middle_school(self):
        print("\n" + "★"*60)
        print(" 🚀 [集群 5: Middle School 中学预备] 启动初级理科与文史收割...")
        print("★"*60)
        ...
        for slug, title, icon in target_books:
            ...
            try:
                ...
                print(f"    ✅ 《{title}》全本采集完毕！")
                data = { "code_id": book_id, "title": title, "provider_type": "Middle School OER", "icon": icon, "is_free": True, "source_url": toc_page_url, "description": "适合初中阶段的纯正北美原版教材，知识密度适中，学科词汇极其丰富。", "chapters_json": chapters_data }
                self.push_to_db("edu_textbooks", data)
            except: pass
...
if __name__ == "__main__":
    print("="*75)
    print("   XuePilot 航母级全球教研爬虫矩阵 (V10.0 满天星终极版)   ")
    print("   ⚠️ 本次扫描涵盖：高等数学、Elson拼读、世界童话及全域英语底座！  ")
    print("   ⏳ 预计耗时 15-30 分钟，请保持终端运行... ")
    print("="*75)
    
    spider = XuePilotK12Spider()
    
    # 1. K-6 核心数学与科普 (含初中代数、几何)
    spider.harvest_wiki_math_and_science()
    
    # 2. 全球经典英文课本 (含 Elson Readers)
    ...
    # 5. Middle School 初中阶理科
    spider.harvest_openstax_middle_school()
    
    print("="*75)
    print(" 🏆 V10.0 全球终极教育底座 搭建完毕！")
    print(" 数学、阅读、科普、童话已全量部署，您的数字图书馆无可挑剔！")
    print("="*75)