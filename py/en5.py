...
# ==============================================================================
# XuePilot OER Spider (V11.0 数学霸权终极收割版 - 全域英文+海量进阶数学+世界童话)
# 核心使命：无死角遍历纯英文小学(K-6)、打通初高中数学全链路 (代数/几何/微积分)。
...
class XuePilotK12Spider:
    ...
    def harvest_wiki_math_and_science(self):
        ...
        books = [
            ...
            ("tb_wiki_trigonometry", "Wikibooks: Trigonometry (High School Math)", "https://en.wikibooks.org/wiki/Trigonometry", "📐"),
            ("tb_wiki_calculus", "Wikibooks: Calculus (AP Math)", "https://en.wikibooks.org/wiki/Calculus", "📈"),
            # 核心科普基石
        ...
        for book_id, title, url, icon in books:
            ...
            try:
                ...
                data = {
                    "code_id": book_id, "title": title, "provider_type": "Primary/Middle Core (K-12)", 
                    "icon": icon, "is_free": True, "source_url": url,
                    "description": "开源纯英文核心教材。涵盖进阶数学体系(代数/几何/微积分)与非虚构类科普。",
    ...
    # ==========================================================================
    # 🎯 集群 5：OpenStax 数学全家桶与核心理科 (全打通版！)
    # ==========================================================================
    def harvest_openstax_math_and_core(self):
        print("\n" + "★"*60)
        print(" 🚀 [集群 5: 数学霸权与中高阶理科] 启动 OpenStax 进阶全系收割...")
        print("★"*60)
        
        target_books = [
            # 极限补充：北美正统数学进阶体系 (从初中到 AP 微积分)
            ("prealgebra-2e", "Prealgebra 2e (预备代数 Grade 6-8)", "📐"),
            ("elementary-algebra-2e", "Elementary Algebra 2e (初级代数 Grade 8-9)", "✖️"),
            ("intermediate-algebra-2e", "Intermediate Algebra 2e (中级代数 Grade 9-11)", "➗"),
            ("algebra-and-trigonometry-2e", "Algebra and Trigonometry 2e (代数与三角函数 Grade 10-12)", "📐"),
            ("precalculus-2e", "Precalculus 2e (微积分预备 Grade 11-12)", "📈"),
            ("calculus-volume-1", "Calculus Volume 1 (微积分卷一 AP Math)", "🚀"),
            # 核心理科
...
if __name__ == "__main__":
    print("="*75)
    print("   XuePilot 航母级全球教研爬虫矩阵 (V11.0 满级数学霸权版)   ")
    ...
    # 5. OpenStax 进阶数学大满贯与核心理科
    spider.harvest_openstax_math_and_core()
    
    print("="*75)
    print(" 🏆 V11.0 满级数学与全球终极教育底座 搭建完毕！")
    print(" 代数、几何、微积分、分级阅读、科普、童话已全量部署，您的数字图书馆无可挑剔！")
    print("="*75)