...
# ==============================================================================
# XuePilot OER Spider (V13.0 终极超神版 - 榨干全网底座，注入顶级私校通识与高维数学)
# 核心使命：补齐北美经典全系(直至高中难度)，注入《平面国》、莎士比亚与房龙大历史。
...
class XuePilotK12Spider:
            ...
            try:
                ...
                if body_content:
                    ...
                    for element in elements:
                        ...
                        # 兼容 Flatland (PART/SECTION) 和数学书 (LESSON/CHAPTER)
                ...
                data = {
                    "code_id": book_id, "title": title, "provider_type": "Elite Math & Philosophy", 
                    "icon": icon, "is_free": True, "source_url": url,
                    "description": "从北美百年经典心算，到培养空间维度降维打击思维的绝世神作《平面国(Flatland)》，构建顶尖极客思维底座。",
    ...
    def harvest_commonwealth_and_us_readers(self):
        ...
        books = [
            ...
            ("tb_ca_ontario_4", "The Ontario Readers: Fourth Book (Canada Grade 4-6)", "https://www.gutenberg.org/files/39922/39922-h/39922-h.htm", "🍁"),
...
if __name__ == "__main__":
    print("="*75)
    print("   XuePilot 航母级全球教研爬虫矩阵 (V13.0 终极超神版)   ")
    print("   ⚠️ 本次扫描涵盖：高维数学《平面国》、McGuffey/Ontario全集、精英私校通识！  ")
    print("   ⏳ 预计耗时 25-50 分钟，请保持终端运行... ")
    print("="*75)
    ...
    print("="*75)
    print(" 🏆 V13.0 超神版全球终极教育底座 搭建完毕！")
    print(" 数学、历史、文学、高维思维全量部署！您的数字帝国已不可战胜！")
    print("="*75)